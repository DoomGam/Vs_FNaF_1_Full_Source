...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		if (!FileSystem.exists(path)) path = "mods/images/gfDanceTitle.json";
		if (!FileSystem.exists(path)) path = "assets/images/gfDanceTitle.json";
	...
	function startIntro()
	{
		...
		if (!FileSystem.exists(path)) path = "mods/images/logoBumpin.png";
		if (!FileSystem.exists(path)) path = "assets/images/logoBumpin.png";
		...
		if (!FileSystem.exists(path)) path = "mods/images/gfDanceTitle.png";
		if (!FileSystem.exists(path)) path = "assets/images/gfDanceTitle.png";
